/*
  # Client Engagement Hub Database Schema

  1. New Tables
    - `interactions` - Log client communications and meetings
    ...
    - `client_teams_channels` - Teams integration per client
...
CREATE TRIGGER trg_client_channels_u 
  BEFORE UPDATE ON public.client_teams_channels 
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_client_channels();