...
const EnhancedRevenueSummary: React.FC<EnhancedRevenueSummaryProps> = ({ 
  targetMonthly = 75000 
}) => {
  const { 
    data: stats, 
...
export default EnhancedRevenueSummary;