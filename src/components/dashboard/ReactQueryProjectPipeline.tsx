...
import { Clock, CheckCircle, AlertCircle, Pause, AlertTriangle, Calendar, RefreshCw } from 'lucide-react';
import { useProjectsQuery, useProjectStatsQuery, useUpdateProjectMutation } from '../../hooks/useReactQuery';
import { ProjectService } from '../../services/projectService';
import { Project } from '../../types/database';

const ReactQueryProjectPipeline: React.FC = () => {
  const { 
    data: projects = [], 
  ...
  if (isLoading && !projects.length && !stats) {
    return (
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    {updateProjectMutation.isPending && updateProjectMutation.variables?.id === project.id && (
...
export default ReactQueryProjectPipeline;