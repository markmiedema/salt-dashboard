...
import { Users, Building, User, Eye, TrendingUp, AlertCircle, RefreshCw } from 'lucide-react';
import { useClientsQuery, useClientStatsQuery } from '../../hooks/useReactQuery';

const ReactQueryClientOverview: React.FC = () => {
  const { 
    data: clients = [], 
  ...
  if (isLoading && !clients.length && !stats) {
    return (
...
export default ReactQueryClientOverview;