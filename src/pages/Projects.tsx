...
const Projects: React.FC = () => {
    ...
    showConfirmation(
      {
        ...
        message:
          'Are you sure you want to delete this project? This action will permanently remove the project and all associated data, including time tracking and revenue records.',
  ...
  if (loading) {
    return (
      <>
        <Helmet>
          <title>Projects - Tax Agency Dashboard</title>
          <meta name="description" content="Track and manage your client projects" />
        </Helmet>
